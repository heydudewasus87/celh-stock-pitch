...
| Method | Value / share | vs. price (~$30.80) |
|--------|---------------|---------------------|
| DCF — base case | $26.23 | −15% |
| DCF — bull case | $37.52 | +22% |
| DCF — bear case | $20.23 | −34% |
| Comps — EV/EBITDA | $39.21 | +27% |
| Comps — P/E | $25.73 | −16% |
| **Blended target** | **$30.39** | **−1%** |
...
~$20 to ~$38 on reasonable changes to WACC and growth alone.

So buying here is a bet that management executes a clean margin recovery *and* keeps growing —
at a price that already assumes they will. That's paying full price for a turnaround before it
shows up in the numbers. There's no **margin of safety**.
...
- **Cheaper than it was.** Down ~50%+ from the highs, and on *adjusted* (non-GAAP) earnings the
  P/E is far more reasonable than the headline GAAP multiple suggests.
- **Optionality.** If margins snap back faster than modeled, the bull-case ~$38 is real upside.

## The bear case (why someone would avoid)

- **Margin recovery is an assumption, not a fact.** The entire valuation hinges on it.
- **Growth is decelerating** off the post-acquisition surge; the easy comps are behind it.
- **Headline risk.** A Texas AG marketing investigation and periodic scrutiny of the energy
  category add tail risk.
- **GAAP optics are ugly.** The high trailing GAAP P/E will scare off some buyers even if
...
- **Assumption-driven.** Like any DCF, the output is only as good as the WACC, growth, and
  ...
  (~$20–$38) as more honest than any single point estimate.
- **The EV/EBITDA comp ($39.21) is the high outlier** and depends on an *estimated* adjusted
  EBITDA (~$500mm) that wasn't pulled from filings. It pulls the comp range up; the P/E comp
  (~$26) and base DCF (~$26) are the more grounded reference points. Refreshing adjusted EBITDA
...
starts to get paid for and the downside is better protected. Above that, you're buying optimism
at full price.

*Personal research and educational project. Not investment advice or a recommendation to buy or
sell any security. Figures as of June 2026 and should be refreshed before use.*
